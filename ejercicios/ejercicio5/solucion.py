...
email = re.compile(r'^\S+@um\.edu\.ar$')
twitter = re.compile(r'^@[A-Za-z0-9_]{1,15}$')
contraseña = re.compile(r'^(?=.*[A-Z])(?=.*[a-z]{2,})(?=.*[0-9!@#$%^&*()_+])[A-Za-z0-9!@#$%^&*()_+]{8,}$') #lookhead
url = re.compile(r'^(http|https):\/\/www\.[a-zA-Z0-9-]+\.[a-z]{2,}\/?$')
ip = re.compile(r'^(\d{1,3}\.){3}\d{1,3}$')
fecha = re.compile(r'^(0[1-9]|[12][0-9]|3[01])[-/](0[1-9]|1[0-2])[-/]\d{4}$')
  ...
  with open(nombre_archivo, 'r') as archivo:
      ...
      for linea in lineas:
        ...
        if 'Email:' in linea:
          ...
          email_search = email.search(linea.split(':')[1].strip())
          if email_search:
        ...
        if 'Twitter:' in linea:
          ...
          twitter_search = twitter.search(linea.split(':')[1].strip())
          if twitter_search:
        ...
        if 'Contraseña:' in linea:
          ...
          contraseña_search = contraseña.search(linea.split(':')[1].strip())
        ...
        if 'URL:' in linea:
          ...
          url_search = url.search(linea.split()[2].strip())
          if url_search:
        ...
        if 'Dirección IP:' in linea:
          ...
          ip_search = ip.search(linea.split(':')[1].strip())
          if ip_search:
        ...
        if 'Fecha:' in linea:
          ...
          fecha_search = fecha.search(linea.split(':')[1].strip())
          if fecha_search:
